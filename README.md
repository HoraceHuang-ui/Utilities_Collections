...
# 目录
- [开发说明](https://github.com/HoraceHuang-ui/Utilities_Collections#开发说明)
- [安装说明](https://github.com/HoraceHuang-ui/Utilities_Collections#安装说明)
- [使用说明](https://github.com/HoraceHuang-ui/Utilities_Collections#使用说明)
  - [主页](https://github.com/HoraceHuang-ui/Utilities_Collections#-主页)
  - [自由计算器](https://github.com/HoraceHuang-ui/Utilities_Collections#-自由计算器)
  - [行列式计算器](https://github.com/HoraceHuang-ui/Utilities_Collections#-行列式计算器)
  - [像素密度计算器](https://github.com/HoraceHuang-ui/Utilities_Collections#-像素密度计算器)
  - [物理实验计算器](https://github.com/HoraceHuang-ui/Utilities_Collections#-物理实验计算器)
  - [随机数生成器](https://github.com/HoraceHuang-ui/Utilities_Collections#-随机数生成器)
  - [必应每日壁纸](https://github.com/HoraceHuang-ui/Utilities_Collections#-必应每日壁纸)
  - [域名解析](https://github.com/HoraceHuang-ui/Utilities_Collections#-域名解析)
  - [IP 地址查询](https://github.com/HoraceHuang-ui/Utilities_Collections#-ip-地址查询)
  - [号码归属地](https://github.com/HoraceHuang-ui/Utilities_Collections#-号码归属地)
  - [倒数日 Days Matter](https://github.com/HoraceHuang-ui/Utilities_Collections#%EF%B8%8F-倒数日-days-matter)
  - [BV / av 号转换](https://github.com/HoraceHuang-ui/Utilities_Collections#-bv--av-号转换)
  - [文本比较器](https://github.com/HoraceHuang-ui/Utilities_Collections#-文本比较器)
  - [命令提示符](https://github.com/HoraceHuang-ui/Utilities_Collections#%EF%B8%8F-命令提示符)
  - [设置页](https://github.com/HoraceHuang-ui/Utilities_Collections#%EF%B8%8F-设置页)
- [其他说明](https://github.com/HoraceHuang-ui/Utilities_Collections#其他说明)
- [代码说明](https://github.com/HoraceHuang-ui/Utilities_Collections#代码说明)
## 开发说明
- 平台：`通用 Windows (UWP)`
...
- 设置中还有 `分辨率` 选项，可设置 `768p、1080p、3840p`
### 🌐 域名解析
